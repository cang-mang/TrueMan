...
static const TrueMan_U8_t TST_req[] = {
...
static const TrueMan_U8_t TST_rsp[] = {
...
int main(void) {
    ...
    printf("len_ctx=%zu\n", TrueMan_CRYPTO_HASH_FNV128A_op.len_ctx);
    printf("len_blk=%zu\n", TrueMan_CRYPTO_HASH_FNV128A_op.len_blk);
    printf("len_dgt=%zu\n", TrueMan_CRYPTO_HASH_FNV128A_op.len_dgt);

    TrueMan_CRYPTO_HASH_FNV128A_final(
        TrueMan_CRYPTO_HASH_FNV128A_update(
            TrueMan_CRYPTO_HASH_FNV128A_update(
                TrueMan_CRYPTO_HASH_FNV128A_update(
                    TrueMan_CRYPTO_HASH_FNV128A_init(&ctx), TST_req, 14
                ),
                TST_req + 26,
                sizeof(TST_req) - 26
            ),
    ...
    TrueMan_CRYPTO_HASH_FNV128A_final(
        TrueMan_CRYPTO_HASH_FNV128A_update(
            TrueMan_CRYPTO_HASH_FNV128A_update(
                TrueMan_CRYPTO_HASH_FNV128A_update(&ctx, TST_rsp, 10),
                TST_rsp + 22,
                sizeof(TST_rsp) - 22
            ),
            "Server",
